...
/*
0: Analog mode							 00
1: Floating input (reset state) 		 01
2: Input with pull-up 					 10
3: Input with pull-down 				 10
4: General purpose output push-pull		 00
5: General purpose output Open-drain	 01
6: Alternate function output Push-pull	 10
7: Alternate function output Open-drain	 11
8: Alternate function input (floating In)01
*/
