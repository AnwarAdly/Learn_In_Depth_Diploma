...
#define NVIC_ISER0	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x0)
#define NVIC_ISER1	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x4)
#define NVIC_ISER2	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x8)
#define NVIC_ICER0	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x80)
#define NVIC_ICER1	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x84)
#define NVIC_ICER2	*(volatile uint32_t *)(NVIC_MEMORY_BASE + 0x88)
...
#define NVIC_IRQ37_UART1_ENABLE			(NVIC_ISER1 |= (1 << 5))
#define NVIC_IRQ38_UART2_ENABLE			(NVIC_ISER1 |= (1 << 6))
#define NVIC_IRQ39_UART3_ENABLE			(NVIC_ISER1 |= (1 << 7))
...
#define NVIC_IRQ37_UART1_DISABLE		(NVIC_ICER1 |= (1 << 5))
#define NVIC_IRQ38_UART2_DISABLE		(NVIC_ICER1 |= (1 << 6))
#define NVIC_IRQ39_UART3_DISABLE		(NVIC_ICER1 |= (1 << 7))
...
#define NVIC_IRQ32_I2C1_ER_DISABLE      (NVIC_ISER1 |= (1 << 0 ))
#define NVIC_IRQ33_I2C2_EV_DISABLE      (NVIC_ISER1 |= (1 << 1 ))
#define NVIC_IRQ34_I2C2_ER_DISABLE      (NVIC_ISER1 |= (1 << 2 ))
